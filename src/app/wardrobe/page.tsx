      ...
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-yellow-50" style={{ backgroundColor: '#f6f1e9' }}>
        ...
        <main className="flex-1 p-6 lg:p-8">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Maintenance Notice */}
            <div className="mb-8 bg-gradient-to-r from-orange-50 to-amber-50 border-2 border-orange-300 rounded-2xl p-6 shadow-lg">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-orange-800 leading-relaxed">
                    Chúng tôi đang nâng cấp tính năng Tủ đồ để mang lại trải nghiệm tốt hơn. 
                    Vui lòng quay lại sau. Xin lỗi vì sự bất tiện này!
                  </p>
                  <p className="text-orange-700 text-sm mt-2">
                    💡 <strong>Gợi ý:</strong> Bạn vẫn có thể sử dụng tính năng Thử đồ ảo và Chat AI bình thường.
                  </p>
                </div>
              </div>
            </div>
