    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Clothify</h2>
        ...
        <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
          ...
          >
            ...
            <motion.button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl"
            >
