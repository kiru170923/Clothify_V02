...
export const MEMBERSHIP_PLANS: Omit<MembershipPlan, 'id' | 'created_at' | 'updated_at'>[] = [
  {
    ...
    features: [
      '30 tokens/tháng',
      'Chat với chatbot 1000 tin nhắn',
      'Lưu trữ tối đa 50 sản phẩm trong tủ đồ',
      'Lưu trữ tối đa 50 ảnh trong lịch sử'
    ],
    is_active: true
  },
  {
    ...
    features: [
      '50 tokens/tháng',
      'Lưu trữ tối đa 200 sản phẩm trong tủ đồ',
      'Lưu trữ tối đa 200 ảnh trong lịch sử',
  ...
  },
  {
    ...
    features: [
      '100 tokens/tháng',
      'Chất lượng ảnh tốt nhất',
      'Thời gian xử lý ảnh nhanh hơn',
